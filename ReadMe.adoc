...
* AsciiDoc-Server: https://ddudde.github.io/EJournal_Client/asciiDoc/
* AsciiDoc-Client: https://ddudde.github.io/EJournal_Client/asciiDoc/client.html
