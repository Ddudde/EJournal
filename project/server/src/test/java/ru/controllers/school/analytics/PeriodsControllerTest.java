...
public class PeriodsControllerTest extends AbstractTestIntegration {
    ...
    @Autowired
    public PeriodsControllerTest(DBService dbService, PeriodsController periodsController) {
        this.dbService = dbService;
        this.testController = periodsController;
    ...
    void addPer_whenGood_HTEACHER() throws Exception {
        ...
        staticMockSSE.verify(() -> SSEController.sendEventFor(eq("addPerC"), answer.capture(), any(), any(), any(), any(), any()));
