...
public class InitDBServiceTest {
    ...
    static void beforeAll() throws NoSuchMethodException {
        getUsersTM = InitDBService.class.getDeclaredMethod("getUsersT", JsonTreeWriter.class, List.class);
    ...
    void testOff_whenGood() {
        ...
        assertNull(initDBService.getSyst());
    }
    ...
    void testOn_whenGood() {
        ...
        assertNotNull(initDBService.getSyst());
    }
    ...
    private void getTestInfo_run(String expected) throws Exception {
        ...
        wrtr.beginObject();
        initDBService.getTestInfo(wrtr);
        wrtr.endObject();
    ...
    private void getUsersT(JsonTreeWriter wrtr, List<User> users) throws InvocationTargetException, IllegalAccessException {
        getUsersTM.invoke(initDBService, wrtr, users);
    }
