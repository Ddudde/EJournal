...
@RestController public class HTeachersController {
    ...
    public JsonObject remGroup(@RequestBody DataHTeachers body) {
        ...
        return datas.getObj(ans -> {
            authController.sendEventFor("remGroupC", ans, TypesConnect.MAIN, ref.schId + "", "main", "ht", "main");
        }, body.wrtr, body.bol);
    }
    ...
    public JsonObject addGroup(@RequestBody DataHTeachers body) {
        ...
        return datas.getObj(ans -> {
            authController.sendEventFor("addGroupC", ans, TypesConnect.MAIN, ref.schId + "", "main", "ht", "main");
        }, body.wrtr, body.bol);
    }
    ...
    public JsonObject chGroup(@RequestBody DataHTeachers body) {
        ...
        return datas.getObj(ans -> {
            authController.sendEventFor("chGroupC", ans, TypesConnect.MAIN, ref.schId + "", "main", "ht", "main");
        }, body.wrtr, body.bol);
    }
    ...
    public JsonObject chPep(@RequestBody DataHTeachers body) {
        ...
        return datas.getObj(ans -> {
            if (user.getSelRole() == 4L) {
                authController.sendEventFor("chInfoL2C", ans, TypesConnect.HTEACHERS, subscriber.getLvlSch(), "main", subscriber.getLvlMore1(), "main");
                authController.sendEventFor("chInfoL1C", ans, TypesConnect.HTEACHERS, ref.sch.getId() + "", "main", "user", "main");
                authController.sendEventFor("chInfoL1C", ans, TypesConnect.HTEACHERS, ref.sch.getId() + "", "main", "ht", "main");
            }
            if (user.getSelRole() == 3L) {
                authController.sendEventFor("chInfoL1C", ans, TypesConnect.HTEACHERS, subscriber.getLvlSch(), "main", subscriber.getLvlMore1(), "main");
                authController.sendEventFor("chInfoL1C", ans, TypesConnect.HTEACHERS, subscriber.getLvlSch(), "main", "user", "main");
    ...
    public JsonObject remPep(@RequestBody DataHTeachers body) {
        ...
        return datas.getObj(ans -> {
            if (user.getSelRole() == 4L) {
                authController.sendEventFor("remInfoL2C", ans, TypesConnect.HTEACHERS, subscriber.getLvlSch(), "main", subscriber.getLvlMore1(), "main");
                authController.sendEventFor("remInfoL1C", ans, TypesConnect.HTEACHERS, ref.sch.getId() + "", "main", "user", "main");
                authController.sendEventFor("remInfoL1C", ans, TypesConnect.HTEACHERS, ref.sch.getId() + "", "main", "ht", "main");
            }
            if (user.getSelRole() == 3L) {
                authController.sendEventFor("remInfoL1C", ans, TypesConnect.HTEACHERS, subscriber.getLvlSch(), "main", subscriber.getLvlMore1(), "main");
                authController.sendEventFor("remInfoL1C", ans, TypesConnect.HTEACHERS, subscriber.getLvlSch(), "main", "user", "main");
    ...
    public JsonObject addPep(@RequestBody DataHTeachers body) {
        ...
        return datas.getObj(ans -> {
            if (user.getSelRole() == 4L) {
                authController.sendEventFor("addInfoL2C", ans, TypesConnect.HTEACHERS, subscriber.getLvlSch(), "main", subscriber.getLvlMore1(), "main");
                authController.sendEventFor("addInfoL1C", ans, TypesConnect.HTEACHERS, ref.schId + "", "main", "user", "main");
                authController.sendEventFor("addInfoL1C", ans, TypesConnect.HTEACHERS, ref.schId + "", "main", "ht", "main");
            }
            if (user.getSelRole() == 3L) {
                authController.sendEventFor("addInfoL1C", ans, TypesConnect.HTEACHERS, subscriber.getLvlSch(), "main", subscriber.getLvlMore1(), "main");
                authController.sendEventFor("addInfoL1C", ans, TypesConnect.HTEACHERS, subscriber.getLvlSch(), "main", "user", "main");
