...
@RestController public class ParentsController {
    ...
    public JsonObject setCodePep(@RequestBody DataParents body) {
        ...
        return datas.getObj(ans -> {
            authController.sendEventFor("codPepL1C", ans, subscriber.getType(), ref.schId + "", subscriber.getLvlGr(), "ht", "main");
        }, body.wrtr, body.bol);
    }
    ...
    public JsonObject addKid(@RequestBody DataParents body) {
        ...
        return datas.getObj(ans -> {
            authController.sendEventFor("addKidC", ans, TypesConnect.PARENTS, subscriber.getLvlSch(), subscriber.getLvlGr(), "main", "main");
        }, body.wrtr, body.bol);
    }
